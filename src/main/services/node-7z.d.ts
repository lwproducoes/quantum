declare module 'node-7z' {
  ...
  export function extract(archive: string, output: string, options?: CommandLineSwitches): ZipStream

  export function list(archive: string, options?: CommandLineSwitches): ZipStream
  ...
  export function test(archive: string, options?: CommandLineSwitches): ZipStream
